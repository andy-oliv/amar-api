/*
  ...
  - Made the column `contractId` on table `financialrecord` required. This step will fail if there are existing NULL values in that column.
...
-- AlterTable
ALTER TABLE `financialrecord` MODIFY `contractId` VARCHAR(191) NOT NULL,
